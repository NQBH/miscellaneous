...
\chapter{\href{https://en.wikipedia.org/wiki/Karl_Weierstrass}{Wikipedia/Karl Weierstrass}}
...
%
Among many other contributions, Weierstrass formalized the definition of the \href{https://en.wikipedia.org/wiki/Continuous_function}{continuity of a function}, proved the \href{https://en.wikipedia.org/wiki/Intermediate_value_theorem}{intermediate value theorem} and the \href{https://en.wikipedia.org/wiki/Bolzano%E2%80%93Weierstrass_theorem}{Bolzano-Weierstrass theorem}, and used the latter to study the properties of continuous functions on closed bounded intervals.
...
\subsection{Soundness of calculus}
...
\subsection{Other analytical theorems}
...
\chapter{\href{https://en.wikipedia.org/wiki/Herbert_Federer}{Wikipedia/Herbert Federer}}
...
\section{Normal \& integral currents}
