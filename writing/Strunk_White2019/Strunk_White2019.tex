...
\begin{enumerate}
    ...
    \item \textbf{This.} The pronoun \textit{this}, referring to the complete sense of a preceding sentence or clause, can't always carry the load adn so may produce an imprecise statement.
    \begin{example}
