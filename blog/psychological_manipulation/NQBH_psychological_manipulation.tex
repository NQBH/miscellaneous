...
\begin{quotation}    
    ...
    Herb Kazzaz: ``\textit{Oh, Bojack, no, there is no other side. This is it.}'' - BoJack Horseman vs. Herb Kazzaz,  Episode: \textit{The View from Halfway Down}, \textit{BoJack Horsemann} (2020)    
\end{quotation}
$\ldots$ Just keep thinking and digging, deeper and harder. There will be a day that monster will be revealed and the hidden truth will be exposed$\ldots$
