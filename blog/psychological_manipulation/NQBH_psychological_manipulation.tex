...
\begin{itemize}
    ...
    \end{align*}
\end{itemize}} to connect as many dots as possible, requires much more time and efforts, especially the expertise/experiences, which are usually possessed/gained only by hardened and/or wise enough individuals. Ironically, in spite of all of these serious investigations, sympathy, empathy, and humanity have been almost all the time being underestimated/undervalued/underrated, even ignored from the majority of human beings, which is the prototypical and fundamental effect of \href{https://dictionary.apa.org/majority-influence}{majority influence}.
...
\textit{But the victim of what? I do not understand.} Like the metaphor about the Black Hole of Truth mentioned above, the conflict between your genuine perception and the toxic reality in any relationships (see, especially, \cite{Bancroft2002}) and any working environments, except the case of \href{https://en.wikipedia.org/wiki/Schizophrenia}{schizophrenia}\footnote{Tâm thần phân liệt.} of course, as a matter of fact, indicates the existence of such an invisible truth-destroyer within your environment, which is usually very close to you: \textit{a psychological manipulator}$\ldots$
