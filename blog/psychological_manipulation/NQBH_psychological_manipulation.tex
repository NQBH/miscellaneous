...
\textit{Is emotion a type of energy?} We are always carried/driven by our own emotions, deliberately/intentionally sometimes and unconsciously some other times: \textit{We live for it, work for it, fight for it, also being taken down because of it}$\ldots$ \textit{We are just emotion's slaves: emotion hiders and/or emotion seekers}$\ldots$
\begin{quotation}
