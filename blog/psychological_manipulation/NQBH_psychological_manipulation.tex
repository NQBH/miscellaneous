...
It seems that psychological manipulation is just another by-product on the \href{https://en.wikipedia.org/wiki/Human_evolution}{human evolution} at the 1st glance: \textit{generally/mostly unexpected} and \textit{unnecessary}. But look closer, think deeper: it actually can be \textit{totally predicted} and \textit{absolutely unavoidable}.
