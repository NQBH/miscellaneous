...
\begin{enumerate}
    ...
    \item \textit{You have to spot that monster/parasite/Shadow King (Fig. \ref{fig3}) out and face/fight/deal with it.}
\end{enumerate}
...
\end{quotation}
Provided you are/feel strong inside, you do not care about psychological manipulator(s) anymore: \textit{No enemy inside $\Rightarrow$ No enemy outside}. Sound perfect then! But the right/real question is: \textit{Can you always be strong/keep being strong all the time in your life?}
\begin{quotation}
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Some combinations of personality traits and their associated potentially developed characters/roles in our ``civilized'' society.}
\end{table}
...
\begin{quotation}
    ``\textit{You know what's more destructive than a nuclear bomb?... Words.}'' - Kim Jong-un, \textit{The Interview} (2014)
\end{quotation}
