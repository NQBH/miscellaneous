...
\noindent
\fbox{\textbf{17}} We start loving something, or being attracted by something, because that thing seems to give us a lot of energy/happiness/emotions\footnote{E.g., music, movie, sport, subject, relationship, career, etc.} and/or release/reduce the pain/suffering\footnote{E.g. lyrics, sex, alcohol, drugs, etc.}. But after playing with it, consuming it for a while, we get bored, we find another one, a new source of emotion generators\footnote{Oh my fucking god, Japanese! You always knew it, didn't you?}. And that will be repeated and repeated. These emotions are exactly the things that make each of us a human being (Fig. \ref{fig5}).

\textit{Is emotion a type of energy?} We are always carried/driven by our own emotions, deliberately/intentionally sometimes and unconsciously some other times: \textit{We live for it, work for it, fight for it, also being taken down because of it}$\ldots$
\begin{quotation}
