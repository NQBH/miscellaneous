...
\noindent
\fbox{\textbf{18}} Several people misunderstand strength as angriness and/or dominant aggression. But the real strength actually is the \textit{calmness under the storm} (Fig. \ref{fig6})$\ldots$ \textit{Listening and observing to understand instead of watching and judging}$\ldots$
