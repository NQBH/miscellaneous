...
\noindent
\fbox{\textbf{17}} We start loving something/someone, or being attracted by something/someone, because that thing/person seems to give us a lot of energy/happiness/emotions\footnote{E.g., music, movie, sport, subject, relationship, career, etc.} and/or reduce/release our pain/suffering\footnote{E.g., lyrics, sex, alcohol, drugs, etc.}. But after playing with it/him/her, consuming it/him/her for a while, we get bored, we find another one, a new source of emotion generators\footnote{Oh my fucking god, Japanese! You always knew it, didn't you?}. And that will be repeated and repeated. These emotions are exactly the things that make each of us a human being (Fig. \ref{fig5})$\ldots$

\textit{Is emotion a type of energy?} We are always carried/driven by our own emotions, deliberately/intentionally sometimes and unconsciously some other times: \textit{We live for it, work for it, fight for it, also being taken down because of it}$\ldots$ \textit{We are just emotion's slaves: emotion hiders and/or seekers}$\ldots$
\begin{quotation}
