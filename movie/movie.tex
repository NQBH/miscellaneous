...
\chapter{Ano hi mita hana no namae o bokutachi wa mada shiranai $\star$ Anohana: The Flower We Saw That Day}
...
\chapter{Hagane no renkinjutsushi $\star$ Fullmetal Alchemist: Brotherhood}

%------------------------------------------------------------------------------%

\chapter{Shigatsu wa kimi no uso $\star$ Your Lie in April}
...
\chapter{Shingeki no kyojin $\star$ Attack on Titan}
...
\chapter{Mushoku-tensei $\sim$Isekai ittara honki dasu $\star$ Mushoku Tensei: Jobless Reincarnation}
