...
\chapter{\href{http://tramdoc.vn/tin-tuc/su-tap-trung-quyet-dinh-trai-nghiem-trai-nghiem-quyet-dinh-cuoc-doi-nMOYnW.html}{Sự Tập Trung Quyết Định Trải Nghiệm, Trải Nghiệm Quyết Định Cuộc Đời}}
...
\section{Yếu tố ngoại cảnh}

\subsection{Kiểm soát công nghệ của bạn}
Hãy nhớ rằng chúng ở đây để phục vụ bạn, không phải ngược lại!
...
\subsection{Kiểm soát môi trường của bạn}
Hãy thiết lập ranh giới với những người khác, đặc biệt là trong không gian văn phòng mở.
...
\section{Cơ chế não bộ}
Nhưng một sự thật bị lãng quên là.
...
\textbf{Ví dụ, vấn đề không chỉ là một email làm gián đoạn công việc của bạn.}

Thực tế là việc bị ``trói buộc'' với hộp thư điện tử khiến bạn cứ vài phút lại trông chờ một sự gián đoạn.
...
\section{Yếu tố nội tại}
Vì vậy, bạn cũng phải học cách kiểm soát những yếu tố nội tại:

\subsection{Kiểm soát hành vi của bạn}
Hãy sử dụng những khoảng thời gian khi công nghệ đã bị ``thuần hóa'' và tấm biển không-làm-phiền được treo lên để làm quen với việc đơn nhiệm (single-tasking).

Chỉ mở một cửa số trên màn hình máy tính.

Toàn tâm toàn ý vào một việc cho đến khi hoàn thành hoặc đến điểm dừng đã định sẵn.
...
Đầu tiên, hãy thử trong 15-20 phút; sau đó nâng lên một tiếng, hay thậm chí 90 phút.

\subsection{Kiểm soát tâm trí của bạn}
Đối với nhiều người trong chúng ta, đây là việc khó khăn nhất.
...
%
Maura Thomas là một diễn giả và huấn luyện viên được giải thưởng quốc tế về năng suất cá nhân và công ty, quản lý sự tập trung và cân bằng giữa công việc và cuộc sống.
...
Cô được vinh danh là một trong Nhà Diễn giả Hàng đầu năm 2018 bởi tạp chí \textit{Inc. Magazine}.\hfill$\square$
\begin{flushright}
